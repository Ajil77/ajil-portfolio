export default function Work() {
    const work = [
        {
            name: 'Food Delivery System for Train Passengers',
            icon: './assets/food-delivery.png',
            description: 'Django • Python • SQLite',
            link: '#',
        },
        {
            name: 'Iris Flower Prediction',
            icon: './assets/iris-prediction.png',
            description: 'Python • Machine Learning • SQLite',
            link: '#',
        },
        {
            name: 'Job Portal Web Application',
            icon: './assets/job-portal.png',
            description: 'Django • Python • SQLite',
            link: '#',
        }
    ];
    ...
    return (
        <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
                A collection of backend-focused projects built using Django and Python,
                emphasizing database-driven applications and practical problem solving.
            </p>
            ...
            <a
                ...
                border border-gray-300 dark:border-white/25 hover:bg-slate-100/70
                dark:hover:bg-darkHover rounded-full py-2 px-8 mx-auto my-20
